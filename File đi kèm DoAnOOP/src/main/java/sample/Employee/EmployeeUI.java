...
public class EmployeeUI {
    ...
    @FXML
    private Button buttonEInformation;
    public void EInformation (ActionEvent event) throws IOException {
        Main m = new Main();
        m.changeScene("EInformation.fxml");
    }
