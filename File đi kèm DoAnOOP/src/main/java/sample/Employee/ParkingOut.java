    ...
    public void TraXe(){
        ...
        try {
            if (loaiThe.equals("Thẻ ngày")) {
                ...
                String query2 = "UPDATE thong_ke_the_ngay SET NgayTra = CURDATE(), GioTra = CURTIME() WHERE MaThe = ?";
                ...
                String query2 = "UPDATE thong_ke_the_thang SET NgayTra = CURDATE(), GioTra = CURTIME() WHERE MaThe = ?";
                PreparedStatement statement2 = connection.prepareStatement(query2);
                statement2.setString(1, maThe);
